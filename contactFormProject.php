...
$confirmation_message = "Your ".$array[2]." has been successfully submitted.<br> A confirmation email has been sent to ".$array[1];

$message = $email_response.$your_message.$confirmation_message;
$response_message = "This is a response email body for the customer";

mail($array[1], "Email Confirmation", $response_message,"From: monesheim@monesheim.com");
mail("monesheim@monesheim.com", $array[2], $message,"From: ".$array[1] );
